function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[2px] items-start left-[calc(50%+0.5px)] top-1/2 translate-x-[-50%] translate-y-[-50%] w-[25px]">
...
export default function Compact() {
  return (
    <div className="relative size-full" data-name="Compact">
