export default function Pill() {
  return (
    <div className="relative size-full" data-name="Pill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 58 58">
        <g clipPath="url(#clip0_210_203)" id="Pill">
          <circle cx="29" cy="29" fill="var(--fill-0, #CEEAF6)" id="Ellipse 3" r="29" />
          <rect height="18" id="Rectangle 43" rx="9" stroke="var(--stroke-0, #2688E4)" width="30" x="14.5" y="20.5" />
        </g>
        <defs>
