...
export default function DemoIntegrationPage() {
  const [selectedEmbed, setSelectedEmbed] = useState<"travel" | "motor">(
    "travel"
  );
          ...
          <div className='flex flex-wrap gap-4 mb-6'>
            ...
            <Card className='flex-1 min-w-[300px] p-4 border-border bg-card'>
              ...
              <div className='flex gap-2'>
                {(Object.keys(embeds) as Array<keyof typeof embeds>).map(
                  (key) => {
        ...
        <Card className='mt-8 p-6 border-border bg-card'>
          ...
          <div className='grid gap-4 md:grid-cols-3'>
            <div className='p-4 bg-muted/30 rounded-lg'>
              ...
              <p className='text-xs text-muted-foreground'>
                Use an iframe or import the component directly into your
                React/Next.js app
              </p>
            </div>
            <div className='p-4 bg-muted/30 rounded-lg'>
              ...
              <p className='text-xs text-muted-foreground'>
                Forms send postMessage events to parent window with real-time
                data
              </p>
            </div>
            <div className='p-4 bg-muted/30 rounded-lg'>
