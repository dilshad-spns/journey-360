  ...
  const embeds = [
    {
      ...
      description:
        "4-step travel insurance form with trip details, traveler info, coverage selection, and payment",
      icon: Plane,
      route: "/embed/travel",
    ...
    },
    {
      ...
      description:
        "4-step death claim form for Universal Life Product (North America Agent Portal)",
      icon: Car,
      route: "/embed/motor",
...
></iframe>`;
  ...
  const getReactCode = (embedId: string) => {
    const componentName =
      embedId === "travel" ? "TravelInsuranceForm" : "DeathClaimForm";
      ...
      <div className='mx-auto px-4 py-12' style={{ maxWidth: "1200px" }}>
            ...
            return (
              <Card key={embed.id} className='p-6 border-border bg-card'>
                <div className='flex items-start gap-4 mb-4'>
                  <div
                    className={`flex items-center justify-center w-12 h-12 rounded-lg ${embed.color}`}
                  >
        ...
        >
          <Card className='p-4 border-border bg-card'>
            <h4 className='mb-2 text-card-foreground'>
              Design System Integration
            </h4>
            <p className='text-sm text-muted-foreground'>
              All forms use CSS variables from your design system for seamless
              theming
            </p>
          </Card>
          <Card className='p-4 border-border bg-card'>
            ...
            <p className='text-sm text-muted-foreground'>
              Forms communicate with parent window via postMessage for data
              updates
            </p>
          </Card>
          <Card className='p-4 border-border bg-card'>
