...
const DeathClaimFormComponent = ({
  ...
  const handleAssessmentComplete = () => {
    ...
    if (result === "rejected") {
      ...
      toast.success(
        result === "approved"
          ? "Claim approved! Proceed to payment details."
          : "Claim referred for review. Proceed to payment details."
      );
    }
  };
        ...
        >
          ...
          <div className='relative overflow-hidden'>
            <div
              ...
              style={{
                backgroundColor:
                  assessmentResult === "rejected" ? "#ffebee" : "#e8f5e9",
              }}
            >
              <div
              ...
              {watchMedicalReason && (
                <div className='flex flex-col gap-1 sm:flex-row sm:justify-between sm:items-center sm:gap-4 min-w-0'>
                  ...
                  <span className='text-foreground capitalize break-words sm:text-right min-w-0 overflow-wrap-anywhere'>
                    {
                      medicalReasons.find((r) => r.value === watchMedicalReason)
                        ?.label
                    }
                  </span>
                </div>
    ...
    >
      ...
      >
        <FileText
          ...
          style={{
            color: themeColors?.[0] ? "var(--theme-primary)" : "var(--primary)",
            strokeWidth: 0.5,
          }}
        />
        <div>
          <h3 className='mb-1 text-foreground'>Claim Main Details</h3>
          <p className='text-muted-foreground'>
            Provide key claim initiation details for the policyholder
          </p>
        </div>
      </div>
      ...
      <StepContentWrapper>
        <FieldWrapper label='Request Date'>
          <Input
            ...
            className='bg-input-background border-border text-muted-foreground cursor-not-allowed'
            style={{
              height: getInputHeight(),
              borderRadius: getInputBorderRadius(),
      ...
      >
        ...
        <div className='space-y-1'>
          <p className='text-foreground text-sm'>Important Information</p>
          <p className='text-muted-foreground text-sm'>
            All information provided will be verified against policy records and
            medical documentation. Ensure accuracy to prevent delays in claim
            processing.
          </p>
        </div>
      </div>
  ...
  const renderStep2 = () => (
    ...
    >
      ...
      >
        ...
        />
        <div>
          <h3 className='mb-1 text-foreground'>Required Documents</h3>
          <p className='text-muted-foreground'>
            Upload all required claim documentation
          </p>
        </div>
      </div>
        ...
        <table className='w-full'>
          <thead>
            <tr className='border-b border-border'>
              <th className='text-left py-3 px-2 text-foreground text-sm'>
                Document Name
              </th>
              <th className='text-left py-3 px-2 text-foreground text-sm hidden md:table-cell'>
                Request Date
              </th>
              <th className='text-left py-3 px-2 text-foreground text-sm'>
                Status
              </th>
              <th className='text-left py-3 px-2 text-foreground text-sm hidden lg:table-cell'>
                Reason
              </th>
              <th className='text-left py-3 px-2 text-foreground text-sm hidden md:table-cell'>
                Received Date
              </th>
              <th className='text-center py-3 px-2 text-foreground text-sm'>
                Upload
              </th>
            </tr>
          </thead>
                ...
                <tr key={doc.id} className='border-b border-border/50'>
                  ...
                  <td className='py-3 px-2'>
                    <Select
                      value={upload.status}
                      onValueChange={(value) =>
                        handleDocumentFieldChange(doc.id, "status", value)
                      }
                    >
                      <SelectTrigger
                  ...
                  <td className='py-3 px-2 hidden lg:table-cell'>
                    <Select
                      value={upload.reason}
                      onValueChange={(value) =>
                        handleDocumentFieldChange(doc.id, "reason", value)
                      }
                    >
                      <SelectTrigger
                    ...
                    <div className='flex items-center justify-center gap-2'>
                      <button
                        ...
                        style={{
                          ...
                          borderRadius: getButtonBorderRadius(),
                          color:
                            upload.uploaded || upload.uploadError
                              ? "white"
                              : "var(--foreground)",
                        }}
                        title={
      ...
      >
        <AlertCircle className='w-5 h-5 text-primary flex-shrink-0 mt-0.5' />
        <div className='space-y-1'>
          <p className='text-foreground text-sm'>Document Requirements</p>
          <p className='text-muted-foreground text-sm'>
            All documents marked with * are required. Accepted formats: PDF,
            JPG, PNG. Maximum file size: 10MB per document.
          </p>
        </div>
      </div>
    </div>
      ...
      <div className='space-y-2'>
        <div className='flex justify-between text-sm'>
          ...
          <span className='text-foreground'>
            ...
            {assessmentQuestions.filter((q) => q.required).length}
          </span>
        </div>
        <div
                ...
                style={{
                  backgroundColor: assessmentAnswers[question.id]
                    ? themeColors?.[0]
                      ...
                      : "var(--accent)"
                    : "var(--muted)",
                  color: assessmentAnswers[question.id]
                    ? "white"
                    : "var(--muted-foreground)",
                  borderRadius: borderRadius === "sharp" ? "0px" : "50%",
                }}
          ...
          style={{
            ...
            backgroundColor: allAssessmentQuestionsAnswered()
              ? themeColors?.[0]
                ...
                : undefined
              : "var(--muted)",
            color: allAssessmentQuestionsAnswered()
              ? "white"
              : "var(--muted-foreground)",
          }}
        >
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className='text-muted-foreground'>
            Set or confirm payment details for the approved claim
          </p>
        </div>
      </div>
      ...
      <StepContentWrapper>
                ...
                <SelectItem key={payee.id} value={payee.id}>
                  <div className='flex flex-col'>
                    ...
                    <span className='text-xs text-muted-foreground'>
                      {payee.relationship} - {payee.bankDetails}
                    </span>
                  </div>
                </SelectItem>
              ))}
          ...
          >
            <div className='flex items-start gap-3'>
              ...
              <div className='flex-1 space-y-2'>
                ...
                {(() => {
                  const selectedPayee = mockPayees.find(
                    (p) => p.id === watchSelectedPayee
                  );
        ...
        <FieldWrapper label='Payment Percentage' required>
          ...
          <p className='text-xs text-muted-foreground mt-1'>
            Default is 100% of the claim amount to the selected payee
          </p>
        </FieldWrapper>
      </StepContentWrapper>
      ...
      >
        ...
        <div className='space-y-1'>
          ...
          <p className='text-muted-foreground text-sm'>
            Payment will be processed within 5-7 business days after claim
            approval. The payee will be notified via email and SMS once payment
            is initiated.
          </p>
        </div>
      </div>
            ...
            <div className='relative z-10 flex flex-col md:flex-row items-center justify-center md:justify-start gap-6 max-w-5xl mx-auto w-full'>
              ...
              <div className='text-center md:text-left flex-1'>
                ...
                >
                  ...
                  >
                    Please provide the required information so we can assist
                    with compassion.
                  </span>
                </p>
              </div>
              ...
              {currentStep === 3 && (
                <Button
                  ...
                  style={{
                    height: getInputHeight(),
                    borderRadius: getButtonBorderRadius(),
                    backgroundColor: canSubmitFinal()
                      ? themeColors?.[0]
                        ? `var(--theme-primary)`
                        : undefined
                      : "var(--muted)",
                    color: canSubmitFinal()
                      ? "white"
                      : "var(--muted-foreground)",
                  }}
                >
