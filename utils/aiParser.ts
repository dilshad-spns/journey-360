...
export class AIParser {
  static parseUserStory(input: string): FormSchema {
    ...
    const isDeathClaim =
      input.toLowerCase().includes("death claim") ||
  ...
  private static getTravelInsuranceSchema(): FormSchema {
    ...
    return {
      ...
      description:
        "Complete your travel insurance purchase through our guided multi-step journey",
      layout: "simple",
      fields: [
        ...
        },
        {
          ...
          // Example: Use static options OR API config
          options: [
            ...
            {
              label: "Worldwide excl. USA, Canada, Caribbean, Mexico",
              value: "worldwide_excl_americas",
            },
          ],
        ...
        },
        {
          ...
          wizardStep: 0,
          description:
            "Must be after start date. Maximum 180 days for single trip.",
        },
        {
          id: "num-travelers",
          name: "num_travelers",
        ...
        },
        {
          ...
          // Example: Use API to fetch nationalities dynamically
          apiConfig: {
            url: "https://mockfast.io/backend/apitemplate/get/FO8778UASO",
            method: "GET",
        ...
        },
        {
          ...
          // Example: Another API example with custom headers
          apiConfig: {
        ...
        },
        {
          ...
          options: [
            {
              label: "Bronze - Essential Coverage ($50/person)",
              value: "bronze",
            },
            {
              label: "Silver - Comprehensive Coverage ($100/person)",
              value: "silver",
            },
          ...
          wizardStep: 2,
          description:
            "Each plan includes medical coverage, trip cancellation, and baggage protection",
        },
        {
          id: "addon-adventure",
          ...
          wizardStep: 2,
          description:
            "Add $25 - Covers skiing, scuba diving, and other adventure activities",
        },
        {
          id: "addon-rental-car",
        ...
        },
        {
          ...
          wizardStep: 2,
          description:
            "Add $20 - Medical and trip cancellation due to COVID-19",
        },
        {
          id: "addon-cancel-any",
          ...
          wizardStep: 2,
          description:
            "Add $40 - Cancel your trip for any reason and get 75% refund",
        },
      ...
      submitUrl: "https://api.example.com/travel-insurance/submit", // Update with your actual API endpoint
      successMessage:
        "🎉 Policy issued successfully! Check your email for policy documents.",
      errorMessage:
        "Failed to process your insurance application. Please try again.",
      metadata: {
        createdAt: timestamp,
  ...
  private static getDeathClaimSchema(): FormSchema {
    ...
    return {
      ...
      description:
        "Submit death claims on behalf of existing clients through the North America Agent Portal",
      layout: "simple",
      fields: [
      ...
      submitUrl: "https://api.example.com/death-claim/submit", // Update with your actual API endpoint
      successMessage:
        "✓ Death claim submitted successfully! Claim ID has been generated.",
      errorMessage:
        "Failed to process death claim submission. Please try again.",
      metadata: {
        createdAt: timestamp,
